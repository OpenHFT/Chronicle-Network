...
public class ConnectionManager<T extends NetworkContext<T>> {
     ...
     */
    private class ConnectionListenerHolder {
        private final int sequence;
        private final ConnectionListener<T> connectionListener;

        public ConnectionListenerHolder(int sequence, ConnectionListener<T> connectionListener) {
     ...
     */
    public static class EventEmitterToken {
